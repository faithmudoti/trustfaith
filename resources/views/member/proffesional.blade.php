    ...
    <div class="container-fluid" id="grad1">
          <div class="col-md-12">
              <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                  <h2><strong>Professional Membership</strong></h2>
                          ...
                          <form id="msform" action="" method="POST">
                              ...
                              <fieldset>
                                  <div class="form-card">
                                      ...
                                      <input type="text" name="fname" placeholder=" Graduating School Name" />
                                      ...
                                      <textarea type="text" name="lname" placeholder="Past Experience" ></textarea>
